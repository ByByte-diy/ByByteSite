...
var lessonsRoutes = [
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-6SSW3OCD.js").then((m) => m.LessonsPageComponent)
  ...
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-WHFGFJH4.js").then((m) => m.LessonDetailPageComponent)
  }, false ? { \u0275entryName: "src/app/modules/lessons/pages/lesson-detail-page/lesson-detail-page.component.ts" } : {})
];
export {
  lessonsRoutes
};
//# sourceMappingURL=chunk-4YNHSQEW.js.map
