...
var lessonsRoutes = [
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-XBJQDZLZ.js").then((m) => m.LessonsPageComponent)
  ...
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-57A5IGHY.js").then((m) => m.LessonDetailPageComponent)
  }, false ? { \u0275entryName: "src/app/modules/lessons/pages/lesson-detail-page/lesson-detail-page.component.ts" } : {})
];
export {
  lessonsRoutes
};
//# sourceMappingURL=chunk-RHOOV4SS.js.map
