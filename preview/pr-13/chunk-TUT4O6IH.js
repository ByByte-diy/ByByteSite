import {
  InfoCardComponent
} from "./chunk-CMCROS4O.js";
import {
  BUTTON_PRESETS
} from "./chunk-VWHM4LEQ.js";
import {
  ButtonComponent
} from "./chunk-HYRVQUMK.js";
import {
  SeoService
...
function HeroCarouselComponent_For_4_Conditional_13_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("href", btn_r1.href, \u0275\u0275sanitizeUrl)("ngClass", "btn--" + btn_r1.color);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 3, btn_r1.text));
  }
}
function HeroCarouselComponent_For_4_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13);
    \u0275\u0275repeaterCreate(1, HeroCarouselComponent_For_4_Conditional_13_For_2_Template, 3, 5, "a", 14, _forTrack1);
    \u0275\u0275pipe(3, "slice");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function HeroCarouselComponent_Conditional_5_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function HeroCarouselComponent_Conditional_5_For_2_Template_button_click_0_listener() {
      ...
      return \u0275\u0275resetView(ctx_r4.goToSlide(\u0275$index_40_r4));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r4 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("carousel-dot--active", ctx_r4.currentSlide() === \u0275$index_40_r4);
    \u0275\u0275attribute("aria-label", "Go to slide " + (\u0275$index_40_r4 + 1));
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HeroCarouselComponent, { className: "HeroCarouselComponent", filePath: "src/app/components/hero-carousel/hero-carousel.ts", lineNumber: 99 });
})();
...
//# sourceMappingURL=chunk-TUT4O6IH.js.map
