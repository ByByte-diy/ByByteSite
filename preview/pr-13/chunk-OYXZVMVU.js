...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BlogComponent, [{
    type: Component,
    args: [{ selector: "app-blog", standalone: true, imports: [TranslateModule], template: `
    <div class="blog-page">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BlogComponent, { className: "BlogComponent", filePath: "src/app/pages/blog/blog.ts", lineNumber: 173 });
})();
export {
  BlogComponent
};
//# sourceMappingURL=chunk-OYXZVMVU.js.map
