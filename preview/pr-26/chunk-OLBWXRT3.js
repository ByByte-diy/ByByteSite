...
var lessonsRoutes = [
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-UR5LDVXR.js").then((m) => m.LessonsPageComponent)
  ...
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-5SY7HCDI.js").then((m) => m.LessonDetailPageComponent)
  }, false ? { \u0275entryName: "src/app/modules/lessons/pages/lesson-detail-page/lesson-detail-page.component.ts" } : {})
];
export {
  lessonsRoutes
};
//# sourceMappingURL=chunk-OLBWXRT3.js.map
