import {
  ...
  LocalizedRoutePipe
} from "./chunk-5Z2ZNHUW.js";
import {
  provideMarkdown
} from "./chunk-6R7IVVPI.js";
import {
  RouterService
} from "./chunk-VE7IDHJX.js";
import {
  CommonModule,
  Component,
  ElementRef,
...
var sharedRoutes = [
  __spreadValues({
    path: "",
    pathMatch: "full",
    loadComponent: () => import("./chunk-HCSCXV6D.js").then((m) => m.Home)
  }, false ? { \u0275entryName: "src/app/pages/home/home.ts" } : {}),
  __spreadValues({
    path: "build",
    loadComponent: () => import("./chunk-44FYYNOR.js").then((m) => m.BuildPage)
  }, false ? { \u0275entryName: "src/app/pages/build/build.ts" } : {}),
  __spreadValues({
    path: "learn",
    loadChildren: () => import("./chunk-OLBWXRT3.js").then((m) => m.lessonsRoutes)
  }, false ? { \u0275entryName: "src/app/modules/lessons/lessons.routes.ts" } : {}),
  __spreadValues({
    path: "community",
    loadComponent: () => import("./chunk-FIJSUMOQ.js").then((m) => m.Community)
  }, false ? { \u0275entryName: "src/app/pages/community/community.ts" } : {}),
  __spreadValues({
    path: "blog",
    loadComponent: () => import("./chunk-IB5GK5BY.js").then((m) => m.BlogComponent)
  }, false ? { \u0275entryName: "src/app/pages/blog/blog.ts" } : {}),
  __spreadValues({
    path: "terms",
    loadComponent: () => import("./chunk-JNJHX7QT.js").then((m) => m.TermsComponent)
  }, false ? { \u0275entryName: "src/app/pages/terms/terms.ts" } : {}),
  __spreadValues({
    path: "privacy",
    loadComponent: () => import("./chunk-PFOUQZPY.js").then((m) => m.PrivacyComponent)
  }, false ? { \u0275entryName: "src/app/pages/privacy/privacy.ts" } : {}),
  __spreadValues({
    path: "**",
    loadComponent: () => import("./chunk-DS6KDG5U.js").then((m) => m.NotFoundComponent)
...
var routes = [
  ...
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-6AFTXIFW.js").then((m) => m.RootPageComponent)
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ThemeToggleComponent, { className: "ThemeToggleComponent", filePath: "app/shared/theme-toggle/theme-toggle.ts", lineNumber: 37 });
})();
...
var SocialLinks = class _SocialLinks {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SocialLinks, selectors: [["app-social-links"]], decls: 8, vars: 4, consts: [["target", "_blank", "rel", "noopener", "aria-label", "YouTube", 1, "social", 3, "href"], [1, "social-icon", 2, "--icon", "url(icons/youtube.svg)"], ["target", "_blank", "rel", "noopener", "aria-label", "Telegram", 1, "social", 3, "href"], [1, "social-icon", 2, "--icon", "url(icons/telegram.svg)"], ["target", "_blank", "rel", "noopener", "aria-label", "Discord", 1, "social", 3, "href"], [1, "social-icon", 2, "--icon", "url(icons/discord.svg)"], ["target", "_blank", "rel", "noopener", "aria-label", "GitHub", 1, "social", 3, "href"], [1, "social-icon", 2, "--icon", "url(icons/github.svg)"]], template: function SocialLinks_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      \u0275\u0275domProperty("href", ctx.env.links.youtubeChannel, \u0275\u0275sanitizeUrl);
      \u0275\u0275advance(2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SocialLinks, { className: "SocialLinks", filePath: "app/shared/social-links/social-links.ts", lineNumber: 85 });
})();
...
var HeaderComponent = class _HeaderComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["app-header"]], hostBindings: function HeaderComponent_HostBindings(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275pipe(12, "localizedRoute");
      \u0275\u0275text(13);
      \u0275\u0275pipe(14, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(15, "a", 6);
      \u0275\u0275pipe(16, "localizedRoute");
      \u0275\u0275text(17);
      \u0275\u0275pipe(18, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(19, "a", 6);
      \u0275\u0275pipe(20, "localizedRoute");
      \u0275\u0275text(21);
      \u0275\u0275pipe(22, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(23, "a", 6);
      \u0275\u0275pipe(24, "localizedRoute");
      \u0275\u0275text(25);
      \u0275\u0275pipe(26, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(27, "div", 7);
      \u0275\u0275element(28, "app-social-links", 8)(29, "app-theme-toggle")(30, "app-lang-switcher");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(31, "div", 9);
      \u0275\u0275element(32, "app-social-links", 10)(33, "app-theme-toggle", 11)(34, "app-lang-switcher", 12);
      ...
      \u0275\u0275element(36, "span")(37, "span")(38, "span");
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275property("routerLink", \u0275\u0275pipeBind1(3, 14, "/"));
      \u0275\u0275attribute("aria-label", \u0275\u0275pipeBind1(4, 16, "brand.name"));
      \u0275\u0275advance(3);
      \u0275\u0275attribute("alt", \u0275\u0275pipeBind1(6, 18, "brand.name"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 20, "brand.name"));
      \u0275\u0275advance(2);
      \u0275\u0275classProp("nav--open", ctx.isMobileMenuOpen());
      \u0275\u0275advance();
      \u0275\u0275property("routerLink", \u0275\u0275pipeBind1(12, 22, "/build"));
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(14, 24, "nav.build"));
      \u0275\u0275advance(2);
      \u0275\u0275property("routerLink", \u0275\u0275pipeBind1(16, 26, "/learn"));
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(18, 28, "nav.learning"));
      \u0275\u0275advance(2);
      \u0275\u0275property("routerLink", \u0275\u0275pipeBind1(20, 30, "/blog"));
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(22, 32, "nav.blog"));
      \u0275\u0275advance(2);
      \u0275\u0275property("routerLink", \u0275\u0275pipeBind1(24, 34, "/community"));
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(26, 36, "nav.community"));
    }
  }, dependencies: [
    CommonModule,
    RouterLink,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HeaderComponent, { className: "HeaderComponent", filePath: "app/components/header/header.ts", lineNumber: 68 });
})();
...
var FooterComponent = class _FooterComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FooterComponent, selectors: [["app-footer"]], decls: 19, vars: 13, consts: [[1, "footer"], [1, "footer__inner"], [1, "footer__left"], [1, "footer__legal"], [1, "footer__links"], [1, "footer__link", 3, "routerLink"], [1, "footer__sep"], [1, "footer__right"]], template: function FooterComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "footer", 0)(1, "div", 1)(2, "div", 2)(3, "div", 3)(4, "span");
      \u0275\u0275text(5);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(6, "nav", 4)(7, "a", 5);
      \u0275\u0275pipe(8, "localizedRoute");
      \u0275\u0275text(9);
      \u0275\u0275pipe(10, "translate");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275pipe(14, "localizedRoute");
      \u0275\u0275text(15);
      \u0275\u0275pipe(16, "translate");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(17, "div", 7);
      \u0275\u0275element(18, "app-social-links");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275property("routerLink", \u0275\u0275pipeBind1(8, 5, "/terms"));
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(10, 7, "terms.title"));
      \u0275\u0275advance(4);
      \u0275\u0275property("routerLink", \u0275\u0275pipeBind1(14, 9, "/privacy"));
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(16, 11, "privacy.title"));
    }
  }, dependencies: [CommonModule, SocialLinks, RouterLink, LanguageModule, TranslateModule, LocalizedRoutePipe, TranslatePipe], styles: ["\n\n.footer[_ngcontent-%COMP%] {\n  background: var(--bg-surface);\n  border-top: 1px solid var(--border-soft);\n  color: var(--text-secondary);\n}\n.footer__inner[_ngcontent-%COMP%] {\n  max-width: 1200px;\n  margin: 0 auto;\n  padding: 16px;\n  display: flex;\n  align-items: center;\n  gap: 16px;\n  justify-content: space-between;\n}\n.footer__left[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  flex-wrap: wrap;\n}\n.footer__links[_ngcontent-%COMP%] {\n  display: inline-flex;\n  gap: 8px;\n}\n.footer__link[_ngcontent-%COMP%] {\n  color: var(--text-secondary);\n  text-decoration: none;\n}\n.footer__link[_ngcontent-%COMP%]:hover {\n  color: var(--text-primary);\n}\n.footer__sep[_ngcontent-%COMP%] {\n  color: var(--text-secondary);\n}\n.footer__right[_ngcontent-%COMP%]   app-social-links[_ngcontent-%COMP%] {\n  display: inline-flex;\n}\n@media (max-width: 768px) {\n  .footer__inner[_ngcontent-%COMP%] {\n    flex-direction: column;\n    align-items: flex-start;\n    gap: 12px;\n  }\n}\n/*# sourceMappingURL=/footer.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FooterComponent, [{
    type: Component,
    args: [{ selector: "app-footer", standalone: true, imports: [CommonModule, SocialLinks, RouterLink, LanguageModule, TranslateModule], template: `
    <footer class="footer">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FooterComponent, { className: "FooterComponent", filePath: "app/components/footer/footer.ts", lineNumber: 37 });
})();
