...
init_core();
init_common();
function InfoCardComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function InfoCardComponent_Conditional_10_For_2_Template(rf, ctx) {
  if (rf & 1) {
...
function InfoCardComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, InfoCardComponent_Conditional_10_For_2_Template, 6, 3, "li", 9, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var InfoCardComponent = class _InfoCardComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InfoCardComponent, selectors: [["app-info-card"]], inputs: { data: "data" }, decls: 11, vars: 11, consts: [[1, "info-card", 3, "ngClass"], [1, "info-card__image"], [1, "image-placeholder"], [1, "placeholder-icon", 3, "src", "alt"], [1, "info-card__content"], [1, "info-card__title"], [1, "info-card__subtitle"], [1, "info-card__description"], [1, "info-card__features"], [1, "feature-item"], [1, "feature-icon"], [1, "feature-text"]], template: function InfoCardComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(7, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(8, InfoCardComponent_Conditional_8_Template, 3, 3, "p", 6);
      \u0275\u0275conditionalCreate(9, InfoCardComponent_Conditional_9_Template, 3, 3, "p", 7);
      \u0275\u0275conditionalCreate(10, InfoCardComponent_Conditional_10_Template, 3, 0, "ul", 8);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance(3);
      \u0275\u0275property("src", ctx.data.image, \u0275\u0275sanitizeUrl)("alt", ctx.data.title);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 9, ctx.data.title));
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.data.subtitle ? 8 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.data.description ? 9 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.data.features && ctx.data.features.length > 0 ? 10 : -1);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InfoCardComponent, { className: "InfoCardComponent", filePath: "app/shared/info-card/info-card.ts", lineNumber: 49 });
})();

export {
  InfoCardComponent
};
//# sourceMappingURL=chunk-VNOJHFW4.js.map
