...
// src/app/i18n/i18n.providers.ts
init_core();
init_http();
init_common();
init_esm();
...
// src/app/components/language-wrapper/language-wrapper.ts
init_core();
init_router();
init_core();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LanguageWrapperComponent, { className: "LanguageWrapperComponent", filePath: "src/app/components/language-wrapper/language-wrapper.ts", lineNumber: 13 });
})();
...
var sharedRoutes = [
  __spreadValues({
    path: "",
    pathMatch: "full",
    loadComponent: () => import("./chunk-2YEOTEII.js").then((m) => m.Home)
  }, false ? { \u0275entryName: "src/app/pages/home/home.ts" } : {}),
  __spreadValues({
    path: "products",
    loadComponent: () => import("./chunk-NUBLFZZN.js").then((m) => m.Products)
  }, false ? { \u0275entryName: "src/app/pages/products/products.ts" } : {}),
  __spreadValues({
    path: "build",
    loadComponent: () => import("./chunk-XIYUBX7B.js").then((m) => m.BuildPage)
  }, false ? { \u0275entryName: "src/app/pages/build/build.ts" } : {}),
  __spreadValues({
    path: "learn",
    loadChildren: () => import("./chunk-466ZT6HQ.js").then((m) => m.lessonsRoutes)
  }, false ? { \u0275entryName: "src/app/modules/lessons/lessons.routes.ts" } : {}),
  __spreadValues({
    path: "docs",
    loadComponent: () => import("./chunk-2D52OFXU.js").then((m) => m.Docs)
  }, false ? { \u0275entryName: "src/app/pages/docs/docs.ts" } : {}),
  __spreadValues({
    path: "community",
    loadComponent: () => import("./chunk-BB3QD2PO.js").then((m) => m.Community)
  }, false ? { \u0275entryName: "src/app/pages/community/community.ts" } : {}),
  __spreadValues({
    path: "blog",
    loadComponent: () => import("./chunk-OYXZVMVU.js").then((m) => m.BlogComponent)
  }, false ? { \u0275entryName: "src/app/pages/blog/blog.ts" } : {}),
  __spreadValues({
    path: "**",
    loadComponent: () => import("./chunk-TEUWP434.js").then((m) => m.NotFoundComponent)
...
var routes = [
  ...
  __spreadValues({
    path: "",
    pathMatch: "full",
    loadComponent: () => import("./chunk-RZRACDQW.js").then((m) => m.RootPageComponent)
...
// src/app/shared/lang-switcher/lang-switcher.ts
init_common();
init_core();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LangSwitcher, { className: "LangSwitcher", filePath: "src/app/shared/lang-switcher/lang-switcher.ts", lineNumber: 32 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HeaderComponent, { className: "HeaderComponent", filePath: "src/app/layout/header/header.ts", lineNumber: 68 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FooterComponent, { className: "FooterComponent", filePath: "src/app/layout/footer/footer.ts", lineNumber: 30 });
})();
