...
function BenefitCardComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 3)(1, "div", 4)(2, "span", 5);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", ctx_r0.data.routerLink);
    \u0275\u0275advance(3);
...
function BenefitCardComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 9)(1, "div", 4)(2, "span", 5);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 6)(5, "h3", 7);
    \u0275\u0275text(6);
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275styleProp("background-color", ctx_r0.data.color);
    \u0275\u0275property("href", ctx_r0.data.href, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r0.data.icon);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 6, ctx_r0.data.title));
...
function BenefitCardComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10)(1, "div", 4)(2, "span", 5);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 6)(5, "h3", 7);
    \u0275\u0275text(6);
...
var BenefitCardComponent = class _BenefitCardComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BenefitCardComponent, selectors: [["app-benefit-card"]], inputs: { data: "data" }, decls: 3, vars: 1, consts: [[1, "benefit-card", "benefit-card--link", 3, "background-color", "routerLink"], ["target", "_blank", "rel", "noopener noreferrer", 1, "benefit-card", "benefit-card--link", 3, "background-color", "href"], [1, "benefit-card", 3, "background-color"], [1, "benefit-card", "benefit-card--link", 3, "routerLink"], [1, "benefit-card__icon"], [1, "benefit-icon"], [1, "benefit-card__content"], [1, "benefit-card__title"], [1, "benefit-card__description"], ["target", "_blank", "rel", "noopener noreferrer", 1, "benefit-card", "benefit-card--link", 3, "href"], [1, "benefit-card"]], template: function BenefitCardComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, BenefitCardComponent_Conditional_0_Template, 11, 10, "a", 0)(1, BenefitCardComponent_Conditional_1_Template, 11, 10, "a", 1)(2, BenefitCardComponent_Conditional_2_Template, 11, 9, "div", 2);
    }
    if (rf & 2) {
      \u0275\u0275conditional(ctx.data.routerLink ? 0 : ctx.data.href ? 1 : 2);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BenefitCardComponent, [{
    type: Component,
    args: [{ selector: "app-benefit-card", standalone: true, imports: [TranslateModule, RouterLink], template: `
    @if (data.routerLink) {
      <a
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BenefitCardComponent, { className: "BenefitCardComponent", filePath: "src/app/shared/benefit-card/benefit-card.ts", lineNumber: 63 });
})();

export {
  BenefitCardComponent
};
//# sourceMappingURL=chunk-TIPW4UYD.js.map
