import {
  ...
  LocalizedRoutePipe
} from "./chunk-OFJGPEOD.js";
import {
  provideMarkdown
} from "./chunk-5ZMW46JO.js";
import {
  RouterService
...
var sharedRoutes = [
  __spreadValues({
    path: "",
    pathMatch: "full",
    loadComponent: () => import("./chunk-W3XNX2CI.js").then((m) => m.Home)
  }, false ? { \u0275entryName: "src/app/pages/home/home.ts" } : {}),
  __spreadValues({
    path: "build",
    loadComponent: () => import("./chunk-RGNGTU6V.js").then((m) => m.BuildPage)
  }, false ? { \u0275entryName: "src/app/pages/build/build.ts" } : {}),
  __spreadValues({
    path: "learn",
    loadChildren: () => import("./chunk-FPYOSWAM.js").then((m) => m.lessonsRoutes)
  }, false ? { \u0275entryName: "src/app/modules/lessons/lessons.routes.ts" } : {}),
  __spreadValues({
    path: "community",
    loadComponent: () => import("./chunk-GLQWP7V7.js").then((m) => m.Community)
  }, false ? { \u0275entryName: "src/app/pages/community/community.ts" } : {}),
  __spreadValues({
    path: "blog",
    loadComponent: () => import("./chunk-YJEJMTSZ.js").then((m) => m.BlogComponent)
  }, false ? { \u0275entryName: "src/app/pages/blog/blog.ts" } : {}),
  __spreadValues({
    path: "terms",
    loadComponent: () => import("./chunk-WJKUTTVT.js").then((m) => m.TermsComponent)
  }, false ? { \u0275entryName: "src/app/pages/terms/terms.ts" } : {}),
  __spreadValues({
    path: "privacy",
    loadComponent: () => import("./chunk-5SJB2V37.js").then((m) => m.PrivacyComponent)
  }, false ? { \u0275entryName: "src/app/pages/privacy/privacy.ts" } : {}),
  __spreadValues({
    path: "**",
    loadComponent: () => import("./chunk-FTWLXPNK.js").then((m) => m.NotFoundComponent)
...
var routes = [
  ...
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-JPVVLLZY.js").then((m) => m.RootPageComponent)
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HeaderComponent, { className: "HeaderComponent", filePath: "src/app/components/header/header.ts", lineNumber: 68 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FooterComponent, { className: "FooterComponent", filePath: "src/app/components/footer/footer.ts", lineNumber: 37 });
})();
