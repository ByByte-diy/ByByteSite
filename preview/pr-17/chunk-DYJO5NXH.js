...
import {
  LessonIconsService,
  LessonsService
} from "./chunk-ZZLTD5R7.js";
import {
  RouterService
} from "./chunk-LVYCFSM4.js";
import {
  SeoModule,
  SeoService
...
function LessonViewComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2)(1, "div", 4)(2, "div", 5)(3, "div", 6)(4, "span", 7);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(8, 9, "lessons.platform." + ctx_r1.lesson.platforms[0]));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r1.iconsService.getLevelIcon(ctx_r1.lesson.level));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(14, 11, "lessons.level." + ctx_r1.lesson.level));
    \u0275\u0275advance(3);
...
var LessonViewComponent = class _LessonViewComponent {
  ...
  }, inputs: { lesson: "lesson" }, features: [\u0275\u0275NgOnChangesFeature], decls: 2, vars: 1, consts: [["markdownContainer", ""], ["previewImage", ""], [1, "lesson-view"], [1, "lesson-loading"], [1, "lesson-header"], [1, "lesson-meta"], [1, "lesson-platform"], [1, "platform-icon"], [1, "platform-name"], [1, "lesson-level"], [1, "level-icon"], [1, "level-name"], [1, "lesson-title"], [1, "lesson-info"], [1, "lesson-tags"], [1, "lesson-version"], [1, "lesson-content"], ["lineNumbers", "", "emoji", "", 1, "markdown-content", 3, "data"], [1, "image-preview-overlay"], [1, "lesson-tag"], [1, "version-label"], [1, "image-preview-overlay", 3, "click"], [1, "image-preview-content", 3, "click", "pointerdown", "pointermove", "pointerup", "pointercancel", "pointerleave", "wheel"], ["draggable", "false", 3, "src", "alt"], [1, "image-preview-controls"], ["type", "button", "aria-label", "Zoom in", 1, "control-btn", 3, "click"], ["type", "button", "aria-label", "Zoom out", 1, "control-btn", 3, "click"], ["type", "button", "aria-label", "Reset zoom", 1, "control-btn", 3, "click"], ["type", "button", "aria-label", "Close image preview", 1, "image-preview-close", 3, "click"]], template: function LessonViewComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, LessonViewComponent_Conditional_0_Template, 24, 13, "div", 2)(1, LessonViewComponent_Conditional_1_Template, 4, 3, "div", 3);
    }
    if (rf & 2) {
...
//# sourceMappingURL=chunk-DYJO5NXH.js.map
