...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LessonFilterComponent, { className: "LessonFilterComponent", filePath: "app/modules/lessons/components/lesson-filter/lesson-filter.component.ts", lineNumber: 12 });
})();
...
var LessonCardComponent = class _LessonCardComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LessonCardComponent, selectors: [["app-lesson-card"]], inputs: { lesson: "lesson" }, decls: 21, vars: 18, consts: [[1, "lesson-card", 3, "click"], [1, "lesson-card__header"], [1, "lesson-platform"], ["loading", "lazy", 1, "platform-icon", 3, "src"], [1, "platform-name"], [1, "lesson-level"], ["loading", "lazy", 1, "level-icon", 3, "src"], [1, "level-name"], [1, "lesson-card__content"], [1, "lesson-title"], [1, "lesson-description"], [1, "lesson-card__footer"], [1, "lesson-tags"], [1, "lesson-version"], [1, "lesson-tag"], [1, "lesson-tag", "more"], [1, "version-label"]], template: function LessonCardComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      \u0275\u0275advance(3);
      \u0275\u0275domProperty("src", ctx.iconsService.getPlatformIcon(ctx.lesson.platforms[0]), \u0275\u0275sanitizeUrl);
      \u0275\u0275attribute("alt", \u0275\u0275pipeBind1(4, 10, "lessons.platform." + ctx.lesson.platforms[0]));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(7, 12, "lessons.platform." + ctx.lesson.platforms[0]));
      \u0275\u0275advance(3);
      \u0275\u0275domProperty("src", ctx.iconsService.getLevelIcon(ctx.lesson.level), \u0275\u0275sanitizeUrl);
      \u0275\u0275attribute("alt", \u0275\u0275pipeBind1(10, 14, "lessons.level." + ctx.lesson.level));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(13, 16, "lessons.level." + ctx.lesson.level));
      \u0275\u0275advance(4);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LessonCardComponent, { className: "LessonCardComponent", filePath: "app/modules/lessons/components/lesson-card/lesson-card.component.ts", lineNumber: 15 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LessonsListComponent, { className: "LessonsListComponent", filePath: "app/modules/lessons/components/lessons-list/lessons-list.component.ts", lineNumber: 18 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LessonsPageComponent, { className: "LessonsPageComponent", filePath: "app/modules/lessons/pages/lessons-page/lessons-page.component.ts", lineNumber: 62 });
})();
export {
  LessonsPageComponent
};
//# sourceMappingURL=chunk-XUMNS4VP.js.map
