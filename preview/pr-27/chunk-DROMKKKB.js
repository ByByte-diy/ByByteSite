...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LessonViewComponent, { className: "LessonViewComponent", filePath: "app/modules/lessons/components/lesson-view/lesson-view.component.ts", lineNumber: 27 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LessonDetailPageComponent, { className: "LessonDetailPageComponent", filePath: "app/modules/lessons/pages/lesson-detail-page/lesson-detail-page.component.ts", lineNumber: 79 });
})();
export {
  LessonDetailPageComponent
};
//# sourceMappingURL=chunk-DROMKKKB.js.map
