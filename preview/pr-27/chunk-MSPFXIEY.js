...
import {
  InfoCardComponent
} from "./chunk-VNOJHFW4.js";
import {
  BUTTON_PRESETS
} from "./chunk-VWHM4LEQ.js";
import {
  ButtonComponent
} from "./chunk-4XFNVSL3.js";
import {
  SeoModule,
  SeoService
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HeroCarouselComponent, { className: "HeroCarouselComponent", filePath: "app/components/hero-carousel/hero-carousel.ts", lineNumber: 103 });
})();
...
var AboutSectionComponent = class _AboutSectionComponent {
  robots = signal([
    ...
    },
    {
      ...
      features: [
        "about.nanoboy.features.0",
        "about.nanoboy.features.1",
        "about.nanoboy.features.2",
        "about.nanoboy.features.3"
      ],
      class: "info-card--nanoboy"
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AboutSectionComponent, { className: "AboutSectionComponent", filePath: "app/components/about-section/about-section.ts", lineNumber: 32 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(WhyImportantComponent, { className: "WhyImportantComponent", filePath: "app/components/why-important/why-important.ts", lineNumber: 27 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CtaSectionComponent, { className: "CtaSectionComponent", filePath: "app/components/cta-section/cta-section.ts", lineNumber: 41 });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Home, { className: "Home", filePath: "app/pages/home/home.ts", lineNumber: 26 });
})();

export {
  Home
};
//# sourceMappingURL=chunk-MSPFXIEY.js.map
