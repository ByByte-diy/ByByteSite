...
var sharedRoutes = [
  __spreadValues({
    path: "",
    pathMatch: "full",
    loadComponent: () => import("./chunk-UDYBMC2G.js").then((m) => m.Home)
  }, false ? { \u0275entryName: "src/app/pages/home/home.ts" } : {}),
  __spreadValues({
    path: "build",
    loadComponent: () => import("./chunk-5V55MC52.js").then((m) => m.BuildPage)
  }, false ? { \u0275entryName: "src/app/pages/build/build.ts" } : {}),
  __spreadValues({
    path: "learn",
    loadChildren: () => import("./chunk-Z4OLB5AH.js").then((m) => m.lessonsRoutes)
  }, false ? { \u0275entryName: "src/app/modules/lessons/lessons.routes.ts" } : {}),
  __spreadValues({
    path: "community",
    loadComponent: () => import("./chunk-ZV77ZPKO.js").then((m) => m.Community)
  }, false ? { \u0275entryName: "src/app/pages/community/community.ts" } : {}),
  __spreadValues({
    path: "blog",
    loadComponent: () => import("./chunk-L27ZE7LD.js").then((m) => m.BlogComponent)
  }, false ? { \u0275entryName: "src/app/pages/blog/blog.ts" } : {}),
  __spreadValues({
    path: "terms",
    loadComponent: () => import("./chunk-JK66WAJU.js").then((m) => m.TermsComponent)
  }, false ? { \u0275entryName: "src/app/pages/terms/terms.ts" } : {}),
  __spreadValues({
    path: "privacy",
    loadComponent: () => import("./chunk-AQSJXLCV.js").then((m) => m.PrivacyComponent)
  }, false ? { \u0275entryName: "src/app/pages/privacy/privacy.ts" } : {}),
  __spreadValues({
    path: "**",
    loadComponent: () => import("./chunk-ZPYRAALU.js").then((m) => m.NotFoundComponent)
...
var routes = [
  ...
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-ILHAWRTT.js").then((m) => m.RootPageComponent)
