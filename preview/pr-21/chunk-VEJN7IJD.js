...
var lessonsRoutes = [
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-74ZB363M.js").then((m) => m.LessonsPageComponent)
  ...
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-SN62OHCB.js").then((m) => m.LessonDetailPageComponent)
  }, false ? { \u0275entryName: "src/app/modules/lessons/pages/lesson-detail-page/lesson-detail-page.component.ts" } : {})
];
export {
  lessonsRoutes
};
//# sourceMappingURL=chunk-VEJN7IJD.js.map
