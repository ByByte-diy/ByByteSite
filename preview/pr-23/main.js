...
var sharedRoutes = [
  __spreadValues({
    path: "",
    pathMatch: "full",
    loadComponent: () => import("./chunk-O74JLQUA.js").then((m) => m.Home)
  }, false ? { \u0275entryName: "src/app/pages/home/home.ts" } : {}),
  __spreadValues({
    path: "build",
    loadComponent: () => import("./chunk-VSXR3NDT.js").then((m) => m.BuildPage)
  }, false ? { \u0275entryName: "src/app/pages/build/build.ts" } : {}),
  __spreadValues({
    path: "learn",
    loadChildren: () => import("./chunk-SXULQHQS.js").then((m) => m.lessonsRoutes)
  }, false ? { \u0275entryName: "src/app/modules/lessons/lessons.routes.ts" } : {}),
  __spreadValues({
    path: "community",
    loadComponent: () => import("./chunk-K33LF366.js").then((m) => m.Community)
  }, false ? { \u0275entryName: "src/app/pages/community/community.ts" } : {}),
  __spreadValues({
    path: "blog",
    loadComponent: () => import("./chunk-XOSPHYWY.js").then((m) => m.BlogComponent)
  }, false ? { \u0275entryName: "src/app/pages/blog/blog.ts" } : {}),
  __spreadValues({
    path: "terms",
    loadComponent: () => import("./chunk-DPMETNRY.js").then((m) => m.TermsComponent)
  }, false ? { \u0275entryName: "src/app/pages/terms/terms.ts" } : {}),
  __spreadValues({
    path: "privacy",
    loadComponent: () => import("./chunk-KAAXPZGM.js").then((m) => m.PrivacyComponent)
  }, false ? { \u0275entryName: "src/app/pages/privacy/privacy.ts" } : {}),
  __spreadValues({
    path: "**",
    loadComponent: () => import("./chunk-OWFIIQIZ.js").then((m) => m.NotFoundComponent)
...
var routes = [
  ...
  __spreadValues({
    ...
    loadComponent: () => import("./chunk-GT5DMWIV.js").then((m) => m.RootPageComponent)
