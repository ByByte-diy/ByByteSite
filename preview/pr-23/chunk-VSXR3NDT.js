import {
  InfoCardComponent
} from "./chunk-AAI5OQEZ.js";
import {
  BenefitCardComponent
} from "./chunk-WH6ZK52V.js";
import {
  BUTTON_PRESETS
} from "./chunk-VWHM4LEQ.js";
import {
  ButtonComponent
} from "./chunk-C4FKLACS.js";
import {
  SeoModule,
  SeoService
} from "./chunk-IGNB2VHK.js";
import {
  CommonModule,
  Component,
  DomSanitizer,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VideoHeroComponent, { className: "VideoHeroComponent", filePath: "src/app/shared/video-hero/video-hero.ts", lineNumber: 86 });
})();
...
var BuildPage = class _BuildPage {
  ...
  megaBtn = () => BUTTON_PRESETS.cta("build.hero.ctaNanoboy", "\u{1F579}\uFE0F");
  nanoBtn = () => BUTTON_PRESETS.cta("build.hero.ctaNano", "\u{1F916}");
  videoButtons = [
    {
...
(() => {
  ...
  `, styles: ["/* src/app/pages/build/build.scss */\n.build-page {\n  padding: 0;\n  background: var(--color-bg);\n  color: var(--text-primary);\n}\n.build-container {\n  max-width: 1200px;\n  margin: 0 auto;\n  padding: 0 1.5rem;\n}\n.build-description {\n  font-size: var(--text-lg);\n  color: var(--text-secondary);\n}\n.build-steps {\n  padding: 3rem 0 4rem;\n  background: var(--color-bg);\n}\n.build-steps__title {\n  font-family: var(--font-display);\n  font-size: var(--text-4xl);\n  font-weight: var(--font-weight-bold);\n  margin: 0 0 2rem 0;\n  color: var(--text-primary);\n  text-align: center;\n}\n.build-steps__grid {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  gap: 1.5rem;\n}\n.build-docs {\n  padding: 3rem 0 4rem;\n  background: var(--color-surface);\n}\n.build-docs__title {\n  font-family: var(--font-display);\n  font-size: var(--text-4xl);\n  font-weight: var(--font-weight-bold);\n  margin: 0 0 1rem 0;\n  color: var(--text-primary);\n  text-align: center;\n}\n.build-docs__description {\n  font-size: var(--text-lg);\n  color: var(--text-secondary);\n  text-align: center;\n  margin: 0 0 3rem 0;\n  max-width: 600px;\n  margin-left: auto;\n  margin-right: auto;\n}\n.build-docs__grid {\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center;\n  gap: 1.5rem;\n}\n.build-docs__grid app-benefit-card {\n  flex: 0 1 calc((100% - 3rem) / 3);\n  max-width: calc((100% - 3rem) / 3);\n}\n@media (max-width: 768px) {\n  .build-steps__grid {\n    grid-template-columns: 1fr;\n  }\n  .build-docs__grid {\n    flex-direction: column;\n    align-items: center;\n  }\n  .build-docs__grid app-benefit-card {\n    flex: 0 1 100%;\n    max-width: 100%;\n  }\n}\n/*# sourceMappingURL=build.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BuildPage, { className: "BuildPage", filePath: "src/app/pages/build/build.ts", lineNumber: 61 });
})();
export {
  BuildPage
};
//# sourceMappingURL=chunk-VSXR3NDT.js.map
